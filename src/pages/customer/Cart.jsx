              ...
              <div className="mb-8">
                ...
                <div className="flex gap-4">
                  ...
                  <button 
                    ...
                    className={`w-16 h-12 flex items-center justify-center border rounded-lg transition ${paymentMethod === 'Cash' ? 'border-green-500 bg-green-50 shadow-sm' : 'border-gray-200 hover:border-gray-300'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`w-16 h-12 flex items-center justify-center border rounded-lg transition ${paymentMethod === 'bKash' ? 'border-pink-500 bg-pink-50 shadow-sm' : 'border-gray-200 hover:border-gray-300'}`}
                  >
